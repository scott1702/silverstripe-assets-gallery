 ...
 *
 * DropzoneUploadField will eventually become UploadField.
 * Until that refactor happens, Dropzone specific behaviour goes here.
 *
...
class DropzoneUploadField extends UploadField
{
    ...
    public function uploadFile(SS_HTTPRequest $request) {
        ...
        if ($folderID == 0) {
            ...
            $folderName = DataObject::get_by_id('Folder', $folderID)->Name;
